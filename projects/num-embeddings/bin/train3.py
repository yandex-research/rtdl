...
class Config:
    ...
    class Bins:
        count: int
        # 'ratio' is equivalent to encoding='piecewise-linear' in train4.py
        # 'one' is equivalent to encoding='binary' in train4.py
    ...
    def __post_init__(self):
        ...
        if self.model.periodic_sigma is not None:
            print('WARNING: "periodic_sigma" is deprecated, use "periodic"')
